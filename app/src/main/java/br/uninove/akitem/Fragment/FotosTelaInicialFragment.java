package br.uninove.akitem.Fragment;
...
public class FotosTelaInicialFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //txtTituloFoto.setText("Aki TEM");

        FirebaseStorage storage = FirebaseStorage.getInstance();
        StorageReference storageReference = storage.getReferenceFromUrl("gs://akitem-f81c3.appspot.com/").child("home.png");
